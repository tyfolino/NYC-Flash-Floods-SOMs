"""
Figure 2 — FFE SOM Node Weights (left) and Raw Composites (right)
...
Usage:
    python -m figures.fig02_ffe_som_node_weights_and_composites
"""
...
def main():
    ...
    # ── Save ──────────────────────────────────────────────────────────────────
    base = os.path.join(OUT_DIR, "fig02_ffe_som")
